...
class Likes {
  ...
  likePost(likeBox) {
    axios__WEBPACK_IMPORTED_MODULE_0___default().post(universityData.root_url + '/wp-json/university/v1/manageLike', {
      professorId: likeBox.dataset.professor
    }).then(response => {
  ...
  unlikePost(likeBox) {
    axios__WEBPACK_IMPORTED_MODULE_0___default()["delete"](universityData.root_url + '/wp-json/university/v1/manageLike', {
      data: {
        like: likeBox.dataset.like
      }
    }).then(response => {
      var likeCount = parseInt(likeBox.querySelector(".like-count").innerText);
      likeCount--;
...
class MyNotes {
  ...
  deleteNote(e) {
    ...
    axios__WEBPACK_IMPORTED_MODULE_0___default()["delete"](universityData.root_url + '/wp-json/wp/v2/note/' + thisNote.dataset.id).then(response => {
  ...
  updateNote(e) {
    ...
    axios__WEBPACK_IMPORTED_MODULE_0___default().post(universityData.root_url + '/wp-json/wp/v2/note/' + thisNote.dataset.id, updatedNote).then(response => {
  ...
  createNote(e) {
    ...
    axios__WEBPACK_IMPORTED_MODULE_0___default().post(universityData.root_url + '/wp-json/wp/v2/note/', newNote).then(response => {
...
class Search {
  ...
  performSearch() {
    ...
    axios__WEBPACK_IMPORTED_MODULE_0___default().get(universityData.root_url + '/wp-json/university/v1/search?term=' + this.searchInput.value).then(response => {
