        ...
        <div className="paying-attention-frontend" style={{ backgroundColor: props.bgColor, textAlign: props.theAlignment }}>
            ...
            <ul>
                {props.answers.map((answer, index) => {
                    return (
                        <li key={index} className={(isCorrectDelayed && index !== props.correctAnswer ? "fade-incorrect" : "") + (isCorrectDelayed && index === props.correctAnswer ? "no-click" : "")} onClick={isCorrect === true ? undefined: () => handleAnswerClick(index)}>
